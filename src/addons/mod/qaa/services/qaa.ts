...
export class AddonModQaaProvider {
    ...
    invalidateContent(moduleId: number, courseId: number, siteId?: string): Promise<void> {
        ...
        promises.push(CoreFilepool.invalidateFilesByComponent(siteId, AddonModQaaProvider.COMPONENT, moduleId));
...
export const AddonModPage = makeSingleton(AddonModQaaProvider);
