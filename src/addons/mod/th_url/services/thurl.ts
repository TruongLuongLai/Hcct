...
const ROOT_CACHE_KEY = 'mmaModThUrl:';
...
export class AddonModUrlProvider {
    ...
    static readonly COMPONENT = 'mmaModThUrl';
    ...
    protected getUrlCacheKey(courseId: number): string {
        return ROOT_CACHE_KEY + 'thurl:' + courseId;
    }
    ...
    protected async getUrlDataByKey(
        ...
        const response = await site.read<AddonModUrlGetUrlsByCoursesResult>('mod_thurl_get_urls_by_courses', params, preSets);
